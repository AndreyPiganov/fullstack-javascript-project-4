...
beforeAll(async () =>{
    ...
    test('pageLoader', async () =>{
        ...
        nock(/ru\.hexlet\.io/).get('/assets/professions/nodejs.png').replyWithFile(getFixturePath('nodejs.png'));
        nock(/ru\.hexlet\.io/).get('/assets/application.css').replyWithFile(getFixturePath('application.css'));
        nock(/ru\.hexlet\.io/).get('/packs/js/runtime.js').replyWithFile(getFixturePath('runtime.js'));
    })*/
